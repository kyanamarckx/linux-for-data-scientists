...
prgent = pd.read_csv('../transform/dataWondelgem.csv').drop_duplicates()
prgent.head()
...
mp.savefig('../graphs/graphWondelgem.png')
mp.clf()
...
map.write_image('../graphs/locationWondelgem.png')

f = open('../descriptives/descriptivesWondelgem.md', 'w')
