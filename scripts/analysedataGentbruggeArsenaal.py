...
prgent = pd.read_csv('../transform/dataGentbruggeArsenaal.csv').drop_duplicates()
prgent.head()
...
ax.set_title("P+R Gentbrugge Arsenaal")
...
mp.savefig('../graphs/graphGentbruggeArsenaal.png')
mp.clf()
...
map.write_image('../graphs/locationGentbruggeArsenaal.png')

f = open('../descriptives/descriptivesGentbruggeArsenaal.md', 'w')
