...
prgent = pd.read_csv('../transform/dataBourgoyen.csv').drop_duplicates()
prgent.head()
...
mp.savefig('../graphs/graphBourgoyen.png')
mp.clf()
...
map.write_image('../graphs/locationBourgoyen.png')

f = open('../descriptives/descriptivesBourgoyen.md', 'w')
