...
prgent = pd.read_csv('../transform/dataTheLoop.csv').drop_duplicates()
prgent.head()
...
mp.savefig('../graphs/graphTheLoop.png')
mp.clf()
...
map.write_image('../graphs/locationTheLoop.png')

f = open('../descriptives/descriptivesTheLoop.md', 'w')
